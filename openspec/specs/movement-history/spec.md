...
Chronological list of recorded movements with filtering, offline support, and sync status indicators. Displays movements from both local storage and server.
